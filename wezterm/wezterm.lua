...
return {
	...
	window_frame = {
		...
		border_left_color = themes[theme].background,
		border_right_color = themes[theme].background,
		border_top_color = themes[theme].background,
		border_bottom_color = themes[theme].background,
	},
